...
# sentiment_classifier documentation build
...
from sentiment_classifier import __version__ as release
...
texinfo_documents = [
    (
        ...
        author,
        "sentiment_classifier",
        "Project sentiment_classifier codebase.",
        "Data-Science",
    )
]
